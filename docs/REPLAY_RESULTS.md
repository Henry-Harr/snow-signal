...
_Regenerated 2026-09-16T16:26:40.581Z by `sentinel replay` (docs/SPEC.md §9.3) — regenerate whenever detectors or thresholds change, per that section's own instruction._
...
- Lead time to WATCH: 1.7d before
- Lead time to DANGER: 1.7d before
- Lead time to CRITICAL: 1.7d before
- Recoverable share at point of no return: 100.0%
- Final decision level: CRITICAL
